<template>
    ...
    <AuthenticatedLayout>
                                        ...
                                        <tbody class="divide-y divide-gray-200 dark:divide-neutral-700">
                                            ...
                                            >
                                                ...
                                                <td
                                                    ...
                                                    <ExampleDecode :text="line.definition" />
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
        ...
        <div
            ...
            class="hidden p-4 bg-white print:block w-a4 h-a4"
        >
            <!-- test title -->
            <div class="pt-2 pb-4 font-medium text-center">
                <h1 class="flex items-center justify-center gap-x-2">単語テスト<span class="text-xs">( {{
                    props.books.data[bookId - 1].title
            ...
            <table class="min-w-full divide-y divide-gray-200 dark:divide-neutral-700">
                ...
                <tbody class="divide-y divide-gray-200 dark:divide-neutral-700 border-spacing-y-[10rem]">
                    <tr
                        v-for="(line, index) in props.lines"
                        :key="index"
                        class="font-normal hover:bg-gray-100 dark:hover:bg-neutral-700"
                    >
                        ...
                        <td
                            class="px-4 py-2 text-[11pt] text-gray-800 text-start whitespace-nowrap dark:text-neutral-200">
        ...
        <div
            ...
            class="hidden p-4 bg-white break-before-page print:block w-a4 h-a4"
        >
            <!-- test title -->
            <div class="pt-2 pb-4 font-medium text-center">
                <h1 class="flex items-center justify-center gap-x-2">単語テスト<span class="text-xs">( {{
            ...
            <table class="min-w-full divide-y divide-gray-200 dark:divide-neutral-700">
                ...
                <tbody class="divide-y divide-gray-200 dark:divide-neutral-700">
                    ...
                    >
                        ...
                        <td
                            class="px-4 py-2 text-[10pt] text-gray-600 text-start whitespace-nowrap dark:text-neutral-200">
...
let bookId = ref(props.bookId ?? 1),
    ...
    theBook = ref(props.books.data[props.bookId - 1]),
    theMaxIndex = theBook.value.max_index ?? 2000;

const validateIndexNoFrom = (value: number): void => {
    if (Number(value) > indexNoTo.value) {
        indexNoTo.value = Number(value) + 99;
    }
};
...
let linesUrl = computed(() => {
    let url = new URL(route('lines.standardTest'));
