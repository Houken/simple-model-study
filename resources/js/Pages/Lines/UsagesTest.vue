<template>
    ...
    <div
        ...
        class="hidden p-4 pt-0 bg-white print:block w-a4 h-a4"
    >
        <!-- test title -->
        <div class="py-0 font-medium text-center">
            <h1 class="flex items-center justify-center gap-x-2 text-sm">単語テスト<span class="text-xs">( {{
        ...
        <table class="min-w-full divide-y divide-gray-200 dark:divide-neutral-700">
            ...
            <tbody class="divide-y divide-gray-200 dark:divide-neutral-700 border-spacing-y-[10rem]">
                ...
                >
                    ...
                    <td class="px-4 py-2 text-[10pt] text-gray-800 text-start whitespace-nowrap">
                        <div class="flex flex-row">
                            <span class="pl-1 tracking-tight">
                                <ExampleQuestion :text="line.usages[0].example" />
                                <ExampleDecode
                                    :text="line.usages[0].translation"
            ...
            <tbody class="divide-y divide-gray-200 dark:divide-neutral-700">
                ...
                >
                    ...
                    <td class="px-4 py-2 text-[10pt] text-gray-600 text-start whitespace-nowrap dark:text-neutral-200">
                        <div class="flex flex-col"><span class="text-[10pt]">
...
let linesUrl = computed(() => {
    let url = new URL(route('test.usage.ej'));
