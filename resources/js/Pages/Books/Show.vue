        ...
        <template #header>
            <div class="flex items-center justify-between">
                <div class="flex items-center">
                    ...
                    <div class="flex ml-4">
                        <Link :href="route('books.show', { book: prevItem })">
                        <SquareChevronLeft
                            :size="28"
                            :stroke-width="1"
                        ...
                        <Link :href="route('books.show', { book: nextItem })">
                        <SquareChevronRight
                            :size="28"
                            :stroke-width="1"
                            class="dark:text-white/75 dark:hover:text-white active:bg-yellow-900"
                ...
                <div>
                    <Link
                        type="button"
                        :href="route('books.edit', { book: book?.data.id })"
...
import { FlashMessage, Book } from '@/types/models';
...
const prevItem = computed(() => {
    if (props.book?.data.id) {
        return props.book?.data.id - 1;
    }
});
